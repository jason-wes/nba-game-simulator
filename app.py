import dash
from dash import dcc # DEPRECATED: import dash_core_components as dcc
from dash import html # DEPRECATED: import dash_html_components as html
...
# dbc.FormGroup deprecated. following is migrated. 
home_team_input = html.Div(
    [
      dbc.Label("Home Team"),
      dcc.Dropdown(
        id='hteam',
...
controls = dbc.Form([home_team_input, away_team_input])
body=True
